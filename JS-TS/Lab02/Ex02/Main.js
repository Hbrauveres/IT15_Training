...
const nome_moeda = ["Real", "Dolar", "Euro"];
const val_moedas = [0.05, 0.10, 0.25, 0.5, 1, 2, 5, 10, 20, 50, 100];
...
for (let i = 0; i < 100; i++) {
    ...
    let moeda = new Moeda(val_moedas[random_valor], nome_moeda[random_nome]);
